...
class queen : public piece
{
    public:
		...
		bool drawRedBoxes(SDL_Renderer*, string, int, map<int, shared_ptr<piece>>) override;
...
queen::queen(string pngInput, char inputColor, int x, int y)
{
    png = pngInput;
	color = inputColor;
	xCoord = x;
...
string queen::getPNG()
	{return png;}
string queen::getIdentity()
	{return identity;}
		
void queen::setxCoord(int x)
	{xCoord = x;}
void queen::setyCoord(int y)
	{yCoord = y;}

bool queen::Draw(SDL_Renderer* renderer)
{
...
void queen::checkDiagOne(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
...
void queen::checkDiagTwo(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
...
void queen::checkDiagThree(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
...
void queen::checkDiagFour(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
	else if(tile % 8 == 0) //Right edge of the board, cannot keep going
...
void queen::checkPathOne(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
	else if(tile < 9)
...
void queen::checkPathTwo(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
	else if((tile+7) % 8 == 0)
...
void queen::checkPathThree(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
	else if(tile > 56)
...
void queen::checkPathFour(SDL_Renderer* renderer, SDL_Texture* redBox, int tile, map<int, shared_ptr<piece>> board, int x, int y)
{
	SDL_Rect box;
	if(tile < 1 || tile > 64) {}
	else if(tile % 8 == 0)
...
bool queen::drawRedBoxes(SDL_Renderer* renderer, string Box, int tileClicked, map<int, shared_ptr<piece>> board)
{
...
bool queen::validMove(int newTileClicked)
{
...
void queen::update(piece &p, int newTileClicked)
{
...
int queen::checkHelper(int tile, int change, map<int, shared_ptr<piece>> board, int &res)
{
...
int queen::check(int tile, map<int, shared_ptr<piece>> board)
{
	int change[8] = {-7, 7, -9, 9, -8, 8, -1, 1}, res = 0;
...
int queen::attackHelper(int location, int change, map<int, shared_ptr<piece>> board)
{
...
bool queen::canAttackTile(int location, int attackerTile, map<int, shared_ptr<piece>> board)
{
	int change[8] = {-7, 7, -9, 9, -8, 8, -1, 1};
